    ...
    <div class="registration-form" style="padding: unset">
        <form method="POST" action="{{route('addBook')}}">
            ...
            <div class="form-group">
                <label style="width: 120px">ISBN:</label><input name="ISBN" type="text" class="form-control item" id="ISBN2" placeholder="Book ISBN">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <button type="submit" style="margin-left: 20px" class="btn btn-block create-account">Add Book</button>
            </div>
        </form>
    </div>
</section>
